/*
	...
	Part 2 of your HOT2 JavaScript Chapters 3 & 4 Hands-On Test.
	
	Using the JavaScript file below, find the 7 errors in the file.
	
	In your code: a) Identify the type of each error (syntax, run-time,
	or logic), b) explain how to fix it, and c) actually make each change
	so that the program runs correctly.  (15 points).
